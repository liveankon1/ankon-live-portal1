  ...
  return (
    <section className="relative isolate overflow-hidden py-14">
      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        ...
        <div className="mt-6 rounded-3xl border border-cyan-300/25 bg-slate-950/45 p-5 shadow-[0_0_28px_rgba(34,211,238,0.15)] backdrop-blur-xl md:p-6">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-200/90">Extra Drop</p>
          <div className="mt-2 flex flex-wrap items-center justify-between gap-4">
            <div>
              <h2 className="text-2xl font-bold text-slate-100">Ankon&apos;s Fair World</h2>
              <p className="mt-1 text-sm text-slate-300">Kept your existing downloads and also added the file you gave.</p>
            </div>
            <a
              href="/Ankons-Fair-World.rar"
              download
